 ...
 * @Description: timer.c
 * @Author: TOTHTOT
 * @Date: 2022-05-22 15:48:05
 * @LastEditTime: 2022-05-22 16:48:39
 * @LastEditors: TOTHTOT
 * @FilePath: \USERe:\Learn\stm32\实例\FFT+OLED\HARDWARE\Timer\timer.c
 */
#include "timer.h"
// #include "adc.h"
#include "usart.h"
...
void AllClock_Init()
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_USART1 | RCC_APB2Periph_GPIOA | RCC_APB2Periph_ADC1 | RCC_APB2Periph_GPIOB, ENABLE); //使能USART1，GPIOA, GPIOC时钟
...
// extern SemaphoreHandle_t FFT_Semaphore;
